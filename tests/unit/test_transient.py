...
class TestTransient:
    ...
    def test_transient_creation(self):
        ...
        transient = Transient(
            time=time, y=flux, y_err=flux_err, data_mode="flux", name="test_transient"
        )
    ...
    def test_from_data_file(self):
        ...
        try:
            transient = Transient.from_data_file(
                temp_filename, data_mode="flux", name="file_test"
            )
    ...
    def test_flux_magnitude_views(self):
        ...
        mag = Transient(time=time, y=y, y_err=y_err, data_mode="magnitude")
...
class TestIntegration:
    ...
    def test_multi_band_data(self):
        ...
        transient = Transient(
            time=time, y=flux, data_mode="flux", bands=bands, name="multi_band_test"
        )
